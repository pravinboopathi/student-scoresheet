  ...
  return (
    <div className="h-screen bg-[#f8fafc] flex flex-col justify-center items-center px-6 text-center">
      <div className="flex flex-col items-center">
        <FaFlag className="text-purple-600 w-16 h-16" />
        <h1 className="mt-8 text-3xl font-bold text-gray-800 md:text-4xl">
          Error 404
        </h1>
        <p className="mt-4 text-lg text-gray-600">
          It looks like something went wrong. You have reached a page that doesn&apos;t exist.
        </p>
        ...
        <button
          ...
          className="mt-8 flex items-center justify-center gap-2 px-6 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition duration-300"
        >
